...
%>
<h3>Liquidaciones pendientes <span class="label bg-azul pull-right" id="label_pendientes"><%= lista_pendientes.size() %></span></h3>
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr id="fila<%= l.getConsecutivo() %>" class="diosnoexiste">
			...
			<td class="text-center"><%= l.getFecha() %></td>
										...
										<div class="media">
											...
											<div class="media-body">
												...
												<ul>
													...
													<li><i><b>Fecha: </b><%= l.getFecha() %></i></li>
