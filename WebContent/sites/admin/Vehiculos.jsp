							...
							<form action="" method="post" id="frm_agregar">
								<div class="modal-body text-left">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="alert alert-danger"
													id="art_uni_num_pl2" role="alert"><span class="icon-error"></span> Unicamente números</div>
												<div class="alert alert-danger"
													id="art_tam_pl2" role="alert"><span class="icon-error"></span> Son exactamente 3 números</div>	
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="alert alert-danger"
													id="art_vacio_tipo" role="alert"><span class="icon-error"></span> Selecciona el tipo de vehículo</div>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="alert alert-success"
										id="art_exito" role="alert"><span class="icon-check_circle"></span> Se agregó el vehículo correctamente</div>	
								</div>
