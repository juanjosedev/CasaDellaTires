...
<!-- 								<button type="button" class="boton boton-chico pull-left" -->
...
<!-- 				<div class="modal fade modal_modificar" -->
<%-- 					id="modificarCliente<%=valor.getNombre()%>"> --%>
<!-- 					<div class="modal-dialog"> -->
<!-- 						<div class="modal-content"> -->
<!-- 							<div class="modal-header"> -->
...
<%-- 											placeholder="Nombre" value="<%=valor.getNombre()%>"> --%>
...
<!-- 									</div> -->
<!-- 									<div class="form-group"> -->
<!-- 										<input name="primer_apellido" type="text" class="form-control" -->
...
<%-- 											placeholder="Teléfono" value="<%=valor.getTelefono()%>"> --%>
<!-- 									</div> -->
<!-- 									<div class="form-group"> -->
<!-- 										<input name="direccion" type="text" class="form-control" -->
<%-- 											placeholder="Dirección" value="<%=valor.getDireccion()%>"> --%>
<!-- 									</div> -->
...
<!-- 										data-dismiss="modal">Cerrar</button> -->
<!-- 									<input type="submit" -->
<%-- 										class="boton boton-chico <%=u.getColor()%>" --%>
		...
		function getPaginas() {
			...
			for(var i = 0; i < listas.length; i++){
				if(listas[i].innerText == pagina_actual){
					listas[i].firstChild.className += "<%=u.getColor()%>
	page_active";
								}
							}
						}
